    ...
    <div class="flex flex-col px-2"
        ...
        <div class="lg:border-t lg:border-b lg:border-gray-200" x-data="{step: 1}">
            <nav class="mx-auto max-w-7xl" aria-label="Progress">
                <ol role="list" class="rounded-md flex border-l border-r border-gray-200 rounded-none">
                    <li class="relative flex-1">
                        <div class="border border-gray-200 overflow-hidden border-b-0 rounded-t-md lg:border-0">
                            ...
                            <span
                                ...
                                <span class="px-6 py-5 flex items-start text-lg font-medium">
              <span class="flex-shrink-0">
                <span class="w-10 h-10 flex items-center justify-center bg-iaho-light-blue rounded-full">
                  <!-- Heroicon name: solid/check -->
                  <x-heroicon-s-check class="text-white"/>
                </span>
              </span>
              <span class="mt-0.5 ml-4 min-w-0 flex flex-col flex-grow">
                <span class="text-base font-semibold tracking-wide uppercase whitespace-nowrap">Conditions</span>
              </span>
            </span>
                            </a>
                        </div>
                    ...
                    <li class="relative flex-1">
                        <div class="border border-gray-200 overflow-hidden border-0">
                            ...
                            <span
                                class="absolute top-0 left-0 w-1 h-full bg-iaho-light-blue lg:w-full lg:h-1 lg:bottom-0 lg:top-auto"
                                aria-hidden="true"></span>
                                <span class="px-6 py-5 flex items-start text-lg font-medium lg:pl-9">
              <span class="flex-shrink-0">
                <span class="w-10 h-10 flex items-center justify-center border-2 border-white rounded-full">
                  <span class="text-white">02</span>
                </span>
              </span>
              <span class="mt-0.5 ml-4 min-w-0 flex flex-col flex-grow">
                <span class="text-base font-semibold text-white tracking-wide uppercase whitespace-nowrap">Level of Care</span>
              </span>
            </span>
                            </a>
              ...
              <span class="mt-0.5 ml-4 min-w-0 flex flex-col flex-grow">
                <span class="text-base font-semibold text-gray-500 tracking-wide uppercase whitespace-nowrap">Public Health Function</span>
              </span>
            </span>
                            </a>
              ...
              <span class="mt-0.5 ml-4 min-w-0 flex flex-col flex-grow">
                <span class="text-base font-semibold text-gray-500 tracking-wide uppercase whitespace-nowrap">Age Cohort</span>
              </span>
            </span>
                            </a>
              ...
              <span class="mt-0.5 ml-4 min-w-0 flex flex-col flex-grow">
                <span
                    class="text-base font-semibold text-gray-500 tracking-wide uppercase whitespace-nowrap">Save & Download Package</span>
              </span>
            </span>
                            </a>
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center">
                                ...
                                <input id="level_of_care_{{ $levelOfCare->id }}" type="checkbox"
                                       class="form-checkbox text-white border-2 rounded-md shadow-sm h4 w4"
