<div>
    ...
    <div class="mx-auto mb-2" x-data="{ refine_search: true }">
        <div class="flex justify-between text-white font-semibold bg-iaho-dark-blue rounded-t-xl">
            ...
            <p class="w-32 cursor-pointer flex justify-end x-4 py-2" x-show="!refine_search"
               x-on:click="refine_search = true">
                <x-heroicon-o-chevron-down class="w-10 text-white"/>
            </p>
            <p class="w-32 cursor-pointer flex justify-end px-4 py-2" x-show="refine_search" x-cloak
               x-on:click="refine_search = false">
                <x-heroicon-o-chevron-up class="w-10 text-white"/>
            </p>
        </div>
        ...
        <div class="align-middle inline-block min-w-full border-b border-gray-200">
            ...
            <table class="min-w-full border-t border-t-gray-200 divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    @endauth
                    <th scope="col"
                        class="px-6 py-3 text-left font-medium text-gray-900">
                        Condition
                    </th>
                    <th scope="col"
                    ...
                    <tr class="{{ $loop->odd ? 'bg-white' : 'bg-gray-50' }}">
                        @auth
                            <td class="px-6 whitespace-nowrap text-left text-gray-500 whitespace-no-wrap">
                                <a href="/nova/resources/intervention-service-areas/{{ $v->id }}/edit?viaResource&viaResourceId&viaRelationship"
                                   title="Edit Intervention" target="_blank" class="inline-flex">
