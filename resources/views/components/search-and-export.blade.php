<div class="mx-auto font-semibold grid grid-cols-6 py-2 px-2 lg:text-sm">
    ...
    <div class="flex col-span-2 justify-around">
        <x-input.text wire:model="filters.search" placeholder="Search Interventions..."
                      class="px-2 rounded border appearance-none flex-1 w-80 placeholder-gray-300 lg:w-64"/>
