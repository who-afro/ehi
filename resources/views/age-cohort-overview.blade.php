<x-app-layout>
    ...
    <div class="max-w-7xl prose px-4">
        <div class="flex">
            <p class="text-xl">The age Cohorts represent the different stages of the human life cycle. They represent an
            ...
            <img src="{{ asset('svg/overview-age-cohort.svg') }}" class="h-40 justify-self-end px-6" alt="Age Cohort Overview" />
        </div>

        @foreach(App\Models\AgeCohort::all() as $ageCohort)
            <span class="text-2xl font-semibold">{{ $ageCohort->name }}</span>
            <div class="flex">
                ...
                <div class="text-xl px-4 !mt-1">
                    ...
                    <a href="/age-cohort/{{ $ageCohort->id }}" title="{{ $ageCohort->name }}" class="flex items-center py-2">
