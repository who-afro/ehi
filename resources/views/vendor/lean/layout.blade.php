...
<body>
    <div class="h-screen flex overflow-hidden bg-gray-100" x-data="{ sidebarOpen: false }"
        ...
        <div x-show="sidebarOpen" class="md:hidden" style="display: none;">
            <div class="fixed inset-0 flex z-40">
                ...
                <div x-show="sidebarOpen" x-description="Off-canvas menu, show/hide based on off-canvas menu state."
                    ...
                    class="relative flex-1 flex flex-col max-w-xs w-full bg-purple-800" style="display: none;">
                    ...
                    <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                        <div class="flex-shrink-0 flex items-center px-4">
                            {{-- <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/v1/workflow-logo-on-brand.svg"
                                alt="Workflow"> --}}
                            <div class="w-full text-purple-100 font-medium text-2xl text-center">{{ Lean::name() }}</div>
                        </div>
                        {{-- todo maybe we want to use blade components instead of @include (also for the other @include call) --}}
                        @include('lean::navigation.mobile')
                    </div>
                        ...
                        <a href="#" class="flex-shrink-0 group block focus:outline-none">
                            <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p
                                        class="text-sm leading-5 font-medium text-purple-300 group-hover:text-purple-100 group-focus:underline transition ease-in-out duration-150">
                                        View profile
                                    </p>
                                </div>
                            </div>
        ...
        <div class="hidden md:flex md:flex-shrink-0">
            <div class="flex flex-col w-64">
                ...
                <div class="flex flex-col h-0 flex-1 bg-purple-800">
                    <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                        ...
                        @include('lean::navigation.desktop')
                    </div>
                    {{-- <div class="flex-shrink-0 flex border-t border-purple-700 p-4">
                        <a href="#" class="flex-shrink-0 w-full group block">
                            <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p
                                        class="text-xs leading-4 font-medium text-purple-300 group-hover:text-purple-100 transition ease-in-out duration-150">
                                        View profile
                                    </p>
                                </div>
                            </div>
    ...
    <script>
        Livewire.hook('element.updating', (fromEl, toEl, component) => {
            let attributes = Object.values(fromEl.attributes);
