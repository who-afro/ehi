<x-app-layout>
    ...
    <div class="max-w-7xl prose">
        ...
        <p>
            ...
            mainly preventive services and limited curative services that are most effectively delivered at that
            level. Countries have defined country specific structures for community health level but a majority
        ...
        <a href="/level-of-care/1" title="Community Level Interventions" class="flex items-center"><x-far-hand-point-right class="mr-3 h-6 w-6 text-blue-500 group-hover:text-blue-600" /> Click here to view the community level interventions </a>
        ...
        <a href="/level-of-care/2" title="Primary Care Level Interventions" class="flex items-center text-blue-700"><x-far-hand-point-right class="mr-3 h-6 w-6 text-blue-500 group-hover:text-blue-600" /> Click here to view the primary care level interventions </a>
        ...
        <ol>
            <li>First level hospital or primary care hospital which is normally a district /sub national level
                ...
                small with just few beds. The facilities usually have basic laboratory services and, basic
                imaging equipment, and the simple surgery is often done under local anesthesia. In some
                countries however the primary care hospitals do have operational theatres but mainly for basic
                uncomplicated surgeries while complex surgeries are referred to higher levels of care
            </li>
            <li>Secondary referral level - a more sophisticated hospital (may be a provincial hospital)
                providing multi-specialist outpatient and inpatient care, and serving as a backstop for the
                first referral hospitals in the hierarchy of technical competence. It may also, on occasion,
                have special expertise in some particular medical diagnostic and treatment domain, which would
                qualify it as an institution of last referral for a specific subject
            </li>
            <li>Tertiary referral hospital - a most sophisticated hospital located in a national or provincial
                capital or other big city, typically a University Teaching Hospital, providing the highest level
                of medical care available in the country or a region. These facilities are highly specialised.
                This level follows a model of centralized expertise and high technology, and is a resource for
                education, training and consultation. Specialists in attendance can monitor and communicate with
                lower level centers by telemedicine
            </li>
        </ol>
        <a href="/level-of-care/3" title="Hospital Level Interventions" class="flex items-center"><x-far-hand-point-right class="mr-3 h-6 w-6 text-blue-500 group-hover:text-blue-600" /> Click here to view the hospital level interventions </a>
    </div>
</x-app-layout>
